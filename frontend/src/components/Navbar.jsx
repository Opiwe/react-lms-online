...
import photoURL from "../assets/home/man.jpg";
...
const Navbar = () => {
    ...
    return (
        ...
        top-0 transition-colors duration-500 ease-in-out w-full z-full z-10`}>
            <div className="lg:w-[95%] mx-auto sm:px-6 lg:px-6">
                ...
                <div onClick={() => navigate('/')} className="flex-shrink-0 cursor-pointer pl-7 md:p-0 flex items-center">
                    <div>
                        ...
                        Eduwise <img src="/eduwise-logo.png" alt="" className="w-8 h-8" />
                        </h1>
